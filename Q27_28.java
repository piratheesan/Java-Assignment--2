...
class Staff
{
	...
	public void requestLeave(String st, String en, String res){
		startDate=st;
		endDate=en;
		reason=res;
	}
	...
	public void getStatus(){
		if(startDate != null){
			if(!Manager.getDecision().equals(" leave is rejected by Manager") && !Hr.getDecision().equals(" leave is rejected by HR") && !Director.getDecision().equals(" leave is rejected by Director")) {
				System.out.println(Manager.getDecision());
				System.out.println(Hr.getDecision());
				System.out.println(Director.getDecision());
			}
			else if(Manager.getDecision().equals(" leave is rejected by Manager")){
				System.out.println(Manager.getDecision());
			}
			else if(Hr.getDecision().equals(" leave is rejected by HR")){
				System.out.println(Hr.getDecision());
			}
			else{
				System.out.println(Director.getDecision());
...
class Manager{
	...
	public boolean printLeave(){
		if(!Hr.getDecision().equals("Pending HR Decision ") && Staff.getType() != null && !Staff.getType().equals("")){
			System.out.println("New Leave Request of "+Staff.getType()+" "+Staff.getUserId()+" : ");
			System.out.println("Start date : "+Staff.getStartDate());
			System.out.println("End date : "+Staff.getEndDate());
			System.out.println("Reason : "+Staff.getReason());
	...
	public void decisionAccept(){
		decision=" leave is accepted by Manager";
	}

	public void decisionReject(){
		decision=" leave is rejected by Manager";
		Staff.cancelRequest();
	}
...
class Director{
	...
	public void decisionAccept(){
		decision=" leave is accepted by Director";
	}

	public void decisionReject(){
		decision=" leave is rejected by Director";
		Staff.cancelRequest();
	}
